...
public class ClinicaVeterinaria {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Mascotas iniciales
        //ID, String nombre, int edad, String raza, Persona duenyo, float peso || String funci�n
        ...
        Perro guau1 = new Perro(3, "GosPolicia", 7, "Pastor Alem�n", luna, "policia");
        listaMascotas.add(guau1);
        Perro guau2 = new Perro(4, "Gosset", 1, "Breton", pepa, "compa��a");
        ...
        do {
            ...
            switch (numero) {
                case 1:
                    //CLIENTE NUEVO
				altaCliente(teclado, clientes, "PRUEBA");
                    break;

                case 2:
                    //CLIENTE EXISTENTE, PRIMERO LO HABREMOS LISTADO CON LA OPCI�N 3
				altaMascota(teclado, listaMascotas, clientes);
                    break;
	...
	private static void altaMascota(BufferedReader teclado, ArrayList<Mascota> listaMascotas,
			ArrayList<Persona> clientes) throws IOException {
		...
		System.out.println("Introduce la identificaci�n");
		long ID = 0;
		try {
		...
		switch (indiceM) {
		    ...
		    case 2:
		        String funcion = "";
		        System.out.println("Introduce la funci�n del perro o la perra");
	...
	private static int altaCliente(BufferedReader teclado, ArrayList<Persona> clientes, String newParam) throws IOException {
		System.out.println("INTRODUCIMOS EL CLIENTE");
		System.out.println("Introduce el nombre");
		String nombre = teclado.readLine();
	...
	public static boolean muestraMenu() {
		System.out.println("=====================================================");
